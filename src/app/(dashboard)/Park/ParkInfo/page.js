...
export default function MunicipalityParkPage({ children }) {
  const router = useRouter();
  const pathname = usePathname();
  const [activeTab, setActiveTab] = useState(null);

  const tabs = [
    { label: 'Basic Info', id: 'basic', route: '/Park/BasicInfo', greenIcon: '/Office/seeding.png', whiteIcon: '/Office/seedingg.png' },
    { label: 'Zone', id: 'zone', route: '/Park/Zone', greenIcon: '/Office/greenzoom.png', whiteIcon: '/Office/whitezoom.png' },
    { label: 'Cameras', id: 'cameras', route: '/Park/Cameras', greenIcon: '/Office/affiliate.png', whiteIcon: '/Office/affiliatee.png' },
    { label: 'Functionality', id: 'functionality', route: '/Park/Functionality', greenIcon: '/Office/refresh.png', whiteIcon: '/Office/refreshh.png' },
    { label: 'Settings', id: 'settings', route: '/Park/Setting', greenIcon: '/Office/device-cctv.png', whiteIcon: '/Office/device-cctvv.png' },
  ];
    ...
    <div className="min-h-screen  space-y-6 bg-gray-50 font-['Public Sans'] w-full space-y-6 mx-auto">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <h1 className="text-xl sm:text-2xl font-sans text-black">
          Municipality Park - مكتب البلدية
        </h1>
        <button
      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="flex flex-col items-center justify-center w-full md:w-[360px] h-auto md:h-[380px] text-black space-y-4 bg-white rounded shadow p-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <p className="text-lg font-semibold text-black">Municipality Park</p>
          </div>
          <p
        ...
        <div className="flex-1 flex flex-col space-y-4">
            ...
            {tabs.map(tab => {
              ...
              return (
                <button
                  ...
                  style={{ width: 133, height: 38, background: isActive ? '#29B171' : '' }}
                >
          ...
          {/* Content */}
          <div className="bg-white min-h-[200px] p-4 rounded shadow">
