  ...
  return (
    <MunicipalityOfficePage>
      <div className="bg-white p-6 w-full max-w-4xl mx-auto">
        {/* Title */}
        <h1 className="text-[18px] font-sans text-black mb-8">Settings</h1>

        {/* Form Fields */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
          {/* Stream URL */}
          <div>
            <label className="block text-[13px] font-sans mb-2 text-black">
              Stream URL
            </label>
            <input
              type="text"
              placeholder="Enter URL Here"
              className="w-full rounded-md px-3 py-2 text-sm outline-none border border-[#2F2B3D38] focus:border-[#29B171] transition"
            />
          </div>
