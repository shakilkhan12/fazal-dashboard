    ...
    <>
      ...
      {isPanelVisible && (
        <div className='fixed inset-0 z-50 flex justify-end items-start bg-transparent mt-20'>
          ...
          >
            {/* Close Button */}
            <div className='flex justify-between items-center mb-6 border-b-1 pb-5'>
              {/* Header Text */}
              <h2
              ...
              {/* Close Button */}
              <button onClick={handleClosePanel} className='p-1 bg-gradient-to-l from-[#2BB673B3] to-[#2BB673] rounded'>
            ...
            {/* Office ID */}
            <div className='mb-4'>
              <label className='block text-sm mb-1 text-black'>Office ID</label>
              <input
                type='text'
                name='id'
            ...
            <div className='flex gap-4'>
              ...
              <button
                ...
                style={{
                  background: 'var(--Color-Palette-error-opacity-light, #FF4C5129)'
                }}
              >
                Cancel
              </button>
