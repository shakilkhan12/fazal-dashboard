  ...
  return (
    ...
    >
      <div className='flex items-center justify-between pli-6 plb-5 '>
        <Typography variant='h5'>Add New Park</Typography>
      ...
      <div className='p-6'>
        <form onSubmit={handleSubmit(data => handleFormSubmit(data))} className='flex flex-col gap-5'>
          <Controller
            ...
            render={({ field }) => (
              <CustomTextField
                ...
                fullWidth
                label='Park ID'
                placeholder='Enter Park ID Here'
          ...
          <div className='flex items-center gap-4'>
            <IconBtn icon={<i className='tabler-plus' />}>Add Park</IconBtn>
