...
const Page = () => {
  ...
  const stats = [
    ...
    { value: 70, label: 'Cases Posted', icon: '/Office/threee.png'},
    { value: 50, label: 'Cases Unposted', icon: '/Office/fourr.png'},
    { value: 150, label: 'Closed Cases', icon: '/Office/fivee.png' },
  ];
  ...
  return (
    <div className="w-full space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
        <h1 className="text-lg sm:text-xl font-semibold text-black">Khorfakkan Central Park -  حديقة خورفكان المركزية</h1>
          ...
          <table className="w-full border-collapse text-xs sm:text-sm min-w-[700px]">
            <thead className="bg-[#F9FAFB]">
              <tr className="border-b border-gray-200 bg-white">
                ...
                <th className="p-3 text-left font-semibold">Event Occurrence</th>
                  ...
                  <tr key={idx} className="hover:bg-gray-50">
                    <td className="p-3 text-[#2F2B3DE5] font-semibold">
                      ...
                      <span className="flex items-center gap-1 text-gray-400 text-xs">
                        <Image src="/Office/worlddd.png" alt="Code Icon" width={14} height={14} />
                        {row.code}
                      </span>
                    </td>
